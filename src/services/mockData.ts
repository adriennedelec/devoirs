...
export const multiplicationSessionMock: MultiplicationSession = {
  ...
  availableTables: [
    ...
    { value: 11, label: 'Table de 11', progressPercent: 0, status: 'not_started', rewardStars: 2 },
    { value: 12, label: 'Table de 12', progressPercent: 0, status: 'not_started', rewardStars: 2 },
    { value: 13, label: 'Table de 13', progressPercent: 0, status: 'not_started', rewardStars: 2 },
    { value: 14, label: 'Table de 14', progressPercent: 0, status: 'not_started', rewardStars: 2 },
    { value: 15, label: 'Table de 15', progressPercent: 0, status: 'not_started', rewardStars: 2 },
    { value: 16, label: 'Table de 16', progressPercent: 0, status: 'not_started', rewardStars: 2 },
    { value: 17, label: 'Table de 17', progressPercent: 0, status: 'not_started', rewardStars: 2 },
    { value: 18, label: 'Table de 18', progressPercent: 0, status: 'not_started', rewardStars: 2 },
    { value: 19, label: 'Table de 19', progressPercent: 0, status: 'not_started', rewardStars: 2 },
    { value: 20, label: 'Table de 20', progressPercent: 0, status: 'not_started', rewardStars: 2 },
  ],
