...
Évolution multiplication validée ensuite : l’écran `Tables de multiplication` adopte une refonte plein écran magique/premium sans sidebar, avec fond violet→bleu pastel nuageux, étoiles, header XXL, carte d’étoiles, sélecteur 2 à 10, cartes de progression, personnages/robot/coffre, aide pédagogique, champs de réponse verticaux et récompense instantanée. Chaque table de 2 à 10 lance désormais 10 calculs couvrant les facteurs 1 à 10 dans le désordre. Une bonne réponse fait avancer automatiquement ; une erreur laisse l’enfant sur le même calcul jusqu’à réussite. Le score final compte uniquement les réussites du premier coup (`1` ou `0` par calcul) et affiche la table complète avec les calculs à retravailler en rouge.
